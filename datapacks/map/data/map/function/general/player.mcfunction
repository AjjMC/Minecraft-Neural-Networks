execute if predicate map:survival_mode run gamemode adventure @s
execute if predicate map:hungry run effect give @s minecraft:saturation 1 0 true

execute at @s if entity @s[y=-64,dy=112] run tp @s 0 63 0 0 0
execute if predicate map:adventure_mode run function map:general/check_item
