...
],title:"Map Info",author:Ajj},minecraft:lore=[{text:"Neural Networks [1.4.0]",color:"gray",italic:0b}]]
...
item replace entity @s hotbar.6 with minecraft:painting[minecraft:custom_data={map:{item:1b,clear_canvas_button:1b}},minecraft:consumable={consume_seconds:2147483647f},minecraft:use_effects={can_sprint:true,speed_multiplier:1f},minecraft:custom_name=[{text:"Clear Canvas",color:"green",italic:0b},{text:" (Right Click)",color:"gray"}]]
